                    ...
                    <div class="col-12 col-sm-6 col-xl-3 mt-3">
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            <div class="card-body">
                                ...
                                <h5 class="card-title font-weight-bold">Farmer Infromations</h5> &nbsp;
                                   <h5 class="card-subtitle mb-2 text-muted"><a href="{{url('farmer')}}">Show</a> &nbsp;<i class="fa-solid fa-hand-point-left fa-beat" style= "color: #011ffe;"></i></h5>
